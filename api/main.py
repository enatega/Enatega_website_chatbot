...
RAG_PROMPT = PromptTemplate.from_template(
    ...
    "• When they ask for quotes/pricing: Direct them to their onboarding dashboard or contact their account manager\n"
    ...
    "FOR REGISTERED USERS (user token present OR onboarding domain):\n"
    "When they ask for quotes/pricing: 'You can access detailed pricing information in your onboarding dashboard. If you need a custom quote, please contact your account manager or use the contact options in your dashboard.'\n"
    "When they express buying intent: 'Great! Since you're already registered, you can proceed with your order through your onboarding dashboard or contact your account manager for assistance.'\n"
